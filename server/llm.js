...
- steps에는 목적 달성까지의 단계를 순서대로 담습니다(보통 2~6단계). 각 단계는 "무엇을 누르고/입력하고/확인하는지" 구체적으로.
- 현재 페이지에서 지금 당장 눌러야 할 곳이 있으면 nextLink에 그 공식 링크(label=official)를 넣습니다. 그게 "지금의 다음 한 걸음"입니다.
- 목적에 맞는 링크가 현재 페이지에 없으면 nextLink는 null로 두고, steps에서 어디로 가야 하는지(예: 상단 메뉴, 검색 등) 설명합니다.
...

{
  ...
  "steps": ["${lang}로 1단계 지시", "2단계 지시", "3단계 지시", "... 목적 달성까지"],
  "nextLink": { "text": "지금 눌러야 할 링크 텍스트", "href": "..." },
